...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public ShooterSubsystem() {
        ...
        frontRightShooterConfig.idleMode(SparkBaseConfig.IdleMode.kCoast).inverted(true).follow(m_frontLeftShooter);
        ...
        rearRightShooterConfig.idleMode(SparkBaseConfig.IdleMode.kCoast).inverted(true).follow(m_rearLeftShooter);

...
public class DriveConstants {
     ...
     */
     ...
     public static final int kRearLeftDrivingCanId = 9999;
     public static final int kRearRightDrivingCanId = 9999;

     public static final int kFrontLeftTurningCanId = 14;
     public static final int kFrontRightTurningCanId = 16;
     public static final int kRearLeftTurningCanId = 9999;
     public static final int kRearRightTurningCanId = 9999;
